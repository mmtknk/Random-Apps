...
table_data = {
    ...
    "BASIS": ["", "", "", "", "", "", "self-citations excluded", "self-citations excluded", "self-citations excluded", "self-citations excluded", "self-citations excluded", "self-citations excluded", "self-citations excluded", "self-citations excluded", "self-citations excluded", "self-citations excluded", "self-citations excluded", "self-citations excluded", "self-citations excluded", "self-citations excluded", "", "all citations", "all citations", "all citations", "all citations", "all citations", "all citations", "all citations", "all citations", "all citations", "all citations", "all citations", "all citations", "all citations", "all citations", "", "", "", "all citations", "all citations", "all citations", "all citations", "all citations", "all citations", "all citations", "self-citations excluded", "", ""],  # Added two placeholders
